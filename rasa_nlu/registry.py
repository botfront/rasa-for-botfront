...
from rasa_nlu.extractors.entity_synonyms_vectors import EntitySynonymsVectors
...
component_classes = [
    ...
    EntitySynonymMapper, EntitySynonymBegin, EntitySynonymEnd, EntitySynonymsVectors,
